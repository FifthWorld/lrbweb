...
set HOST=lrb_svr:8080
set SVC_BASE=sola/webservices

"C:\Program Files\Microsoft SDKs\Windows\v7.0A\bin\svcutil" /language:cs /config:Ignore.config /n:http://webservices.sola.org/search,org.sola.webservices.search /n:*,org.sola.webservices.search.extra /edb /serializer:XmlSerializer /fault /ct:System.Collections.ArrayList /out:SearchService ./wsdl/SearchService.wsdl
"C:\Program Files\Microsoft SDKs\Windows\v7.0A\bin\svcutil" /language:cs /config:Ignore.config /n:http://webservices.sola.org/administrative,org.sola.webservices.administrative /n:*,org.sola.webservices.administrative.extra /edb /serializer:XmlSerializer /fault /ct:System.Collections.ArrayList /out:AdministrativeService ./wsdl/AdministrativeService.wsdl
...
"C:\Program Files\Microsoft SDKs\Windows\v7.0A\bin\svcutil" /language:cs /config:SearchService.config /n:*,org.sola.webservices.search /edb /serializer:XmlSerializer /fault /ct:System.Collections.ArrayList /out:Ignore http://%HOST%/%SVC_BASE%/search-service?wsdl
"C:\Program Files\Microsoft SDKs\Windows\v7.0A\bin\svcutil" /language:cs /config:AdministrativeService.config /n:*,org.sola.webservices.administrative /edb /serializer:XmlSerializer /fault /ct:System.Collections.ArrayList /out:Ignore http://%HOST%/%SVC_BASE%/administrative-service?wsdl
"C:\Program Files\Microsoft SDKs\Windows\v7.0A\bin\svcutil" /language:cs /config:CasemanagementService.config /n:*,org.sola.webservices.casemanagement /edb /serializer:XmlSerializer /fault /ct:System.Collections.ArrayList /out:Ignore http://%HOST%/%SVC_BASE%/casemanagement-service?wsdl
"C:\Program Files\Microsoft SDKs\Windows\v7.0A\bin\svcutil" /language:cs /config:FilestreamingService.config /n:*,org.sola.webservices.filestreaming /edb /serializer:XmlSerializer /fault /ct:System.Collections.ArrayList /out:Ignore http://%HOST%/%SVC_BASE%/filestreaming-service?wsdl
"C:\Program Files\Microsoft SDKs\Windows\v7.0A\bin\svcutil" /language:cs /config:ReferencedataService.config /n:*,org.sola.webservices.referencedata /edb /serializer:XmlSerializer /fault /ct:System.Collections.ArrayList /out:Ignore http://%HOST%/%SVC_BASE%/referencedata-service?wsdl
"C:\Program Files\Microsoft SDKs\Windows\v7.0A\bin\svcutil" /language:cs /config:DigitalArchiveService.config /n:*,org.sola.webservices.digitalarchive /edb /serializer:XmlSerializer /fault /ct:System.Collections.ArrayList /out:Ignore http://%HOST%/%SVC_BASE%/digitalarchive-service?wsdl
pause